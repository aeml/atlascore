...
namespace simlab
{
    // Deterministic FNV-1a based hashing over simulation state for regression tests,
    // headless analysis, and repeated-run validation.
    class WorldHasher
    {
    public:
        ...
        std::uint64_t HashWorld(const ecs::World& world) const noexcept;
